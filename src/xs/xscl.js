...
var xscl = (function() {
  var _scriptDir =
    typeof document !== 'undefined' && document.currentScript
      ...
      : undefined;
  return function(xscl) {
    xscl = xscl || {};

    var Module = typeof xscl !== 'undefined' ? xscl : {};
    var moduleOverrides = {};
    var key;
    for (key in Module) {
    ...
    var STATIC_BASE = 1024,
      DYNAMIC_BASE = 5281920,
      DYNAMICTOP_PTR = 38784;
    ...
    var _fxLink = (Module['_fxLink'] = function() {

/*
!!!!PATCHED BY HAND!!!!
Line 6: meta.import changed (https://github.com/emscripten-core/emscripten/issues/8729)
Line 524: declared undefined vars (https://github.com/emscripten-core/emscripten/issues/8774)
*/
var tools = (function() {
  var _scriptDir =
  ...
  return function(tools) {
    ...
    var STATIC_BASE = 1024,
      ...
      STACKTOP = STACK_BASE,
      STACK_MAX = 323872,
      DYNAMIC_BASE = 5566752,
      DYNAMICTOP_PTR = 323840;
    ...
    var ___tm_current = 323696;

    var ___tm_timezone = (stringToUTF8('GMT', 323744, 4), 323744);
    ...
    var asmLibraryArg = {
      ...
      pthread_cond_signal: _pthread_cond_signal,
      pthread_cond_timedwait: _pthread_cond_timedwait,
      pthread_cond_wait: _pthread_cond_wait,
      round: _round,
